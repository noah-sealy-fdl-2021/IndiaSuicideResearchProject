...
# processed_suicide_data.csv is used for map
                        ...
                        children=[
                            dbc.Col(
                                children=[
                                    ...
                                    html.P(id='type_code_error', children='No state(s) selected!', hidden=False,
                                           style={'color': 'red'}),
                                ]
                            )
                        ],
...
def update_graph(slider_select):
    ...
    fig = px.choropleth(
        ...
        locations='State',
        color='Suicide Rate',  # z
        hover_data=['State', 'Population', 'Total', 'Suicide Rate'],
        color_continuous_scale='PuRd',
        range_color=[0, 40],
        labels={'Suicide Rate': 'Suicide Rate'},
    )
